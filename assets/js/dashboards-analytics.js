...
.catch(error => console.error("Error:", error));
  ...
  // Total Revenue Report Chart - Bar Chart
  // --------------------------------------------------------------------
  const totalRevenueChartEl1 = document.querySelector('#totalRevenueChart1'),
    totalRevenueChartOptions1 = {
      series: [
        {
          name: new Date().getFullYear() - 1,
          data: [18, 15, 15, 29, 18, 1, 29]
        },
        {
          name: new Date().getFullYear() - 2,
          data: [-13, -18, -9, -14, -8, -17, -15]
  ...
  if (typeof totalRevenueChartEl1 !== undefined && totalRevenueChartEl1 !== null) {
    const totalRevenueChart1 = new ApexCharts(totalRevenueChartEl1, totalRevenueChartOptions1);
  ...
  if (typeof growthChartEl1 !== undefined && growthChartEl1 !== null) {
    const growthChart1 = new ApexCharts(growthChartEl1, growthChartOptions1);
    growthChart1.render();
  }
  ...
  const chartOrderStatistics = document.querySelector('#orderStatisticsChart'),
    orderChartConfig = {
      ...
      labels: ['Streaming', 'Servicios Básicos', 'Entretenimiento', 'Arriendo'],
      series: [50, 85, 25, 40],
